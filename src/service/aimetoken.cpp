...
HOOK_ADDR_LAZY(
    ...
    DBG("RunCloudProxyCallback, task_id = {}, content = {}",
        task_id,
        content.view());
...
HOOK_ADDR_LAZY(
    ...
    DBG("InsertCloudProxyCallback, task_id = {}", task_id);
...
HOOK_ADDR_LAZY(
    ...
    DBG("SendCloudProxyTransferRequest, task_id = {}, content = {}",
        task_id,
        content.view());
